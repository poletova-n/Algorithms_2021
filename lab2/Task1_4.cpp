...
int main()
{
    ...
    std::cout << "Vvedite gde stoit Ferz: ";
    std::cin >> X1 >> Y1;
    ...
    if (((X1 - X2 == Y1 - Y2)) or (((X1 == X2) and (Y1 != Y2)) or ((X1 != X2) and (Y1 == Y2))))
    {
        std::cout << "Figura budet siedena";
    }
    else
    {
        std::cout << "Ferz ne smoget siest figuru";
    }
    return 0;
}
#include <iostream>
...
int main()
{
    ...
    if (((X1 - X2 == Y1 - Y2)) and (((X1 == X2) and (Y1 != Y2)) or ((X1 != X2) and (Y1 == Y2))))
    {
        std::cout << "Figura budet siedena";
    }
    else
