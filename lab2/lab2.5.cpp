...
int main() {
    ...
    if((hunter[0] + 1 == victim[0]) and (hunter[1] + 2  == victim[1]))  {
        cout << "Конь съедает фигуру противника";
    }

    else if ((hunter[0] - 1 == victim[0]) and (hunter[1] + 2 == victim[1])) {
        cout << "Конь съедает фигуру противника";
    }

    else if ((hunter[0] + 2 == victim[0]) and (hunter[1] + 1 == victim[1])) {
        cout << "Конь съедает фигуру противника";
    }
        ...
        cout << "Конь не может съесть фигуру противника";
    }
