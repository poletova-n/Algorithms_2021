...
int main() {
    ...
    if (cin >> voroni) {
        ...
        else
        {
            ...
            cout << "Можно использовать только целые неотрицательные числа - Вы ввели нецелые числа";
            cin.ignore(100, '\n');
            cin.clear();
            return 1;
    ...
    if ((voroni < 0)) {
        cout << "Можно использовать только целые неотрицательные числа - Вы ввели отрицательные числа";
        return 1;
    }
