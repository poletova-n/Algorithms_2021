...
int main()
{
    try {
        ...
        std::ifstream input(R"(D:\PTcodes\c++\GitPull\Algorithms_2021\ind5\input\input_1.txt)");
        if (!input.is_open())
        {
        ...
        std::ofstream output(R"(D:\PTcodes\c++\GitPull\Algorithms_2021\ind5\output\output_1.txt)");
        if (!output.is_open())
        {
