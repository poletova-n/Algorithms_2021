...
int main() {
	...
	std::cout << "Cреднее арифметическое всех введенных чисел: " << 1.0*sum/count) << std::endl;
	std::cout << "Cреднее арифметическое всех положительных введенных чисел: " <<  1.0*positive_sum/positive_count << std::endl;
	std::cout << "Максимальное значение и его номер среди всех введенных чисел: " << maximal << " " << maximal_index << std::endl;
	std::cout << "Минимальное положительное значение и его номер среди всех введенных чисел: " << static_cast<int>(minimal) << " " << minimal_index << std::endl;
	return 0;
}