...
int main() {
    ...
    std::cout << "Введите числовую последовательность для определения среднего арифметического всех введенных чисел. (Последовательность должна оканчиваться числом 0) " << std::endl;
